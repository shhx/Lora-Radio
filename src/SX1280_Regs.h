...
#define SX1280_REG_LORA_SYNC_WORD                   0x944
...
typedef enum
{
    SX1280_RX_GAIN_LP = 0x00,   // Low Power
    SX1280_RX_GAIN_HS = 0xC0,   // High Sensitivity
} SX1280_RxGainRegime_t;
...
typedef enum
{
    SX1280_RADIO_STDBY_RC   = 0x02,
    SX1280_RADIO_STDBY_XOSC = 0x03,
    SX1280_RADIO_FS         = 0x04,
    SX1280_RADIO_RX         = 0x05,
    SX1280_RADIO_TX         = 0x06,
